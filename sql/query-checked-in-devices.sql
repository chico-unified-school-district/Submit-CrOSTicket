SELECT
 ...
 CASE 
  ...
  WHEN [DRA].[CC] = 'E' THEN 'Keyc Set-ADUser -Replace @{msExchHideFromAddressLists=$false}ap Missing'
...
WHERE
 --DRI.BC = 'CB201800014508' AND STU.ID = 80212 AND
 DRA.CD <> 'R'
 AND DRA.DD IS NULL
 AND DRA.CD <> ' '
 AND DRA.RID = 1
 ...
 AND ( DRA.RD > '2019-8-31' ) -- Older enteries can be ignored
